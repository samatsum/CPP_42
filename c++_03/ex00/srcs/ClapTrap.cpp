...
/*   Updated: 2025/05/08 17:12:50 by samatsum         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ClapTrap::beRepaired(unsigned int amount)
{
	...
	{
		this->_hit_points += amount;
		std::cout << "ClapTrap " << this->_name << " repaired hisself and gained " << amount << " of hit points, Now hit_points is " << this->_hit_points << std::endl;
		this->_energy_points--;
	}
	else if (this->_energy_points <= 0)
		std::cout << "ClapTrap " << this->_name << " is not able to repair hisself, because He does not have energy_points " << std::endl;
	else if (this->_hit_points <= 0)
		std::cout << "ClapTrap " << this->_name << " is not able to repair hisself, because He does not have hit_points " << std::endl;
}